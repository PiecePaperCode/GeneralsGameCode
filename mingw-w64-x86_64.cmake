...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fdeclspec -Wno-invalid-noreturn -Wno-microsoft -Wno-attributes -Wno-unused-variable -Wno-undef")
add_definitions(-D_aligned_malloc=aligned_malloc)
add_compile_options(-D_aligned_malloc=aligned_alloc)
add_compile_options(-Wno-non-pod-varargs -Wno-writable-strings -Wno-undef)
